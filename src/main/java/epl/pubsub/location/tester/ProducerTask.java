...
class ProducerTask implements Runnable {
  ...
  public ProducerTask(
    PulsarLocationProducer producer,
    String payload,
    int interval,
    String topic
  ) {
  ...
  public double getAggregatedPublishLatency() {
    ...
    return (
      metrics.aggregatePublishLatency.get() / metrics.numMessagesPublished.get()
    );
  }
  ...
  public double getSubscriptionChangeLatency() {
    ...
    return (
      metrics.aggregateTopicChangeLatency.get() / metrics.numTopicChanges.get()
    );
  }
}
